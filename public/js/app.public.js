...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _general_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./general/modal */ "./resources/js/general/modal.js");
/* harmony import */ var _general_modal__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_general_modal__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _general_notify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./general/notify */ "./resources/js/general/notify.js");
...
window.livewire.on('closeModals', function () {
  window.location.href = "#";
});

/***/ }),

/***/ "./resources/js/general/notify.js":
/*!****************************************!*\
  !*** ./resources/js/general/notify.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
window.livewire.on('notify', function (type) {
...
const DEV$1 = "development" !== 'production';
/**
...
function handleAutoplay(slider) {
    ...
    if (config.stopAutoplayOnInteraction !== false) {
        slider.el.addEventListener('pointerdown', () => {
...
function setDrag(slider, amount) {
    slider.el.style.setProperty('--dragged', amount + '');
}

function swipe(slider, dir) {
    const time = 90;
...
function isTransitioning(slider, time = slider.currentTransitionDuration) {
...
function setCSS(slider) {
    const { slidesToShow, transitionDuration, slideGap, transitionTimingFunction, } = slider.config;
    // layout
    slider.el.style.setProperty('--slides-to-show', slidesToShow + '');
    slider.el.style.setProperty('--slide-gap', slideGap);
    // transition
    slider.el.style.setProperty('--transition-duration', transitionDuration + 'ms');
    slider.el.style.setProperty('--transition-timing-function', transitionTimingFunction + '');
}
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/blaze-slider/dist/blaze.css":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/blaze-slider/dist/blaze.css ***!
  \************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".blaze-slider{--dragged:0;--slides-to-show:1;--offset:0;--slide-gap:20px;--total-gap:(var(--slides-to-show) - 1) * var(--slide-gap);--slide-width:calc((100% - var(--total-gap)) / var(--slides-to-show));--transition-duration:200ms;--transition-timing-function:ease;direction:ltr}.blaze-track>*{box-sizing:border-box}.blaze-slider:not(.static) .blaze-track{cursor:-webkit-grab;cursor:grab}.blaze-container{position:relative}.blaze-track-container{overflow:hidden}.blaze-track{touch-action:pan-y;display:flex;gap:var(--slide-gap);transform:translateX(calc(var(--offset)*(var(--slide-gap) + var(--slide-width)) + calc(1px*var(--dragged))));transition:transform var(--transition-duration) var(--transition-timing-function)}.blaze-slider.dragging .blaze-track,.blaze-slider.no-transition .blaze-track{transition:none!important}.blaze-track>*{width:var(--slide-width);flex-shrink:0}.blaze-slider.dragging{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:-webkit-grabbing;cursor:grabbing}", ""]);
// Exports
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_blaze_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./blaze.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/blaze-slider/dist/blaze.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_blaze_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_blaze_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var blaze_slider_dist_blaze_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! blaze-slider/dist/blaze.css */ "./node_modules/blaze-slider/dist/blaze.css");
...
/* harmony import */ var uid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! uid */ "./node_modules/uid/dist/index.mjs");
/* harmony import */ var scroll_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! scroll-js */ "./node_modules/scroll-js/dist/scroll.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('scrollTo', function (className) {
  return {
    focusTo: function focusTo() {
      (0,scroll_js__WEBPACK_IMPORTED_MODULE_5__.scrollIntoView)(document.body.getElementsByClassName(className)[0], document.body, {
        behavior: 'smooth'
      });
    }
  };
});
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('heroMain', function (className) {
  return {
    swiper: null,
    init: function init() {
      new blaze_slider__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector(className), {
        all: {
          slidesToScroll: 1,
          slidesToShow: 1,
          enableAutoplay: true
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('registrarPasajeros', function (_ref) {
  var $wire = _ref.$wire;
  return {
    tab: '',
    init: function init() {
      this.$store.adquisicionPasaje.tarifas = $wire.tarifas_ida.map(function (el) {
        return {
          id: el.tarifa.id,
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('formAddPasajero', function () {
  return {
    ...
    init: function init() {
      ...
      this.$watch('tipo_documento_id', function (value) {
        _this.nro_documento_type = value == 'DNI' ? 'number' : 'text';
      });
    },
    save: function save(tarifa, $wire) {
      // let fecha_nacimiento = dayjs(this.fecha_nacimiento, 'YYYY-MM-DD')
      var fecha_actual = dayjs();
      var edad = fecha_actual.diff(this.fecha_nacimiento, 'year');
      ...
      var pasajero = {
        uid: (0,uid__WEBPACK_IMPORTED_MODULE_4__.uid)(),
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('general', {
  sideBar: false,
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('adquisicionPasaje', {
  tab: 'search-vuelo',
  vuelosIda: [],
  vuelosVuelta: [],
  // pasajeros: [],
  tarifas: [],
  setPasajero: function setPasajero(tarifa, $pasajero) {
    this.tarifas.map(function (tar) {
      return tar.id == tarifa.id && tar.pasajeros.push($pasajero);
    });
    console.log(this.tarifas); // this.pasajeros.push($pasajero)
  },
  isTarifaCompleted: function isTarifaCompleted(tarifa) {
    return tarifa.pasajeros.length >= tarifa.nro;
  },
  getNroPasajerosRegistered: function getNroPasajerosRegistered(tarifa) {
    return this.pasajeros.reduce();
  },
  deletePasajero: function deletePasajero(tarifa, pasajeroUid) {
    this.tarifas.map(function (tar) {
      if (tar.id == tarifa.id) {
        return tar.pasajeros = tar.pasajeros.filter(function (pas) {
          return pas.uid !== pasajeroUid;
        });
      }
