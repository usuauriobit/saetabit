...
class IncidenciaAvion extends Model
{
    use HasFactory;
    use SoftDeletes;
    public $fillable = [
    ...
    public function avion_before(): BelongsTo { return $this->belongsTo(Avion::class, 'avion_before_id', 'id'); }
    public function avion_after(): BelongsTo { return $this->belongsTo(Avion::class, 'avion_after_id', 'id'); }
