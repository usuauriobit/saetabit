...
class PasajeCambioVuelo extends Model
{
    use HasFactory;
    use SoftDeletes;
    ...
    public function vuelo(): BelongsTo { return $this->belongsTo(Vuelo::class)->withTrashed(); }
    public function pasaje_cambio(): BelongsTo { return $this->belongsTo(PasajeCambio::class); }
